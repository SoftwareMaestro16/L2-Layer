...
| 12 | Fraud proof verifier groundwork | Move from observer replay to witness-bearing evidence for future L1-verifiable missing-DA and invalid-root challenges. | `feat/l1-fraud-proof-verifier` | `feat(challenge): add l1 fraud proof verifier groundwork` | Witness format tests, invalid-root and missing-DA observer tests, checkpoint/witness integrity checks, docs showing the future L1 `ChallengeBatch` path. |
