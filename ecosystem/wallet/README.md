...
- Stores the seed phrase in browser `localStorage` for this prototype.
- Reads live balances and transaction history from the Entropis L2 node.
- Signs and submits ENT transfers locally.
...
This is testnet-only. Do not reuse a seed phrase from another wallet.
